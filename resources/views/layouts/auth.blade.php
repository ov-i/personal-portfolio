...
<body class="antialiased bg-admin-dirt-white">

<div id="app" class="app" v-cloak role="application">
    <!-- main content -->
    <main class="main main-content w-screen h-screen flex justify-center items-center" id="main-content" aria-label="Główna treść" role="main">
        @yield('content')
    </main>
</div>
